...
var logName = "update_education_plans_aos";
...
if(ArrayCount(educationPlans) > 0) {
    try {
        for(educationPlan in educationPlans) {
            ...
            if(ArrayCount(ArraySelect(educationPlanDoc.TopElem.programs, "This.type == 'education_method' && This.state_id > 0")) > 0) {
                Log(logName, "Пропускаем план с id:" + educationPlan.id + " есть учебные программы со статусом > 0");
                continue;
            }
